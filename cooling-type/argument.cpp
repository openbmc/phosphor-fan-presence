...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr << "\nThe --air / --water options may be given in addtion to "
              ...
              "effect.\n";
    std::cerr << std::flush;
//--air : Force 'AirCooled' property to be set.
//--water : Force 'WaterCooled' property to be set.
//--gpio=<pin> : GPIO pin to determine 'WaterCooled' (true) and
//                         'AirCooled' (false)
//                         --path : *Required* ...
//
//                         The --air / --water options may be given in addition to --gpio, in which case both their
//                         setting and the GPIO will take effect.
}

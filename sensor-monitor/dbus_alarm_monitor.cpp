...
DbusAlarmMonitor::DbusAlarmMonitor(sdbusplus::bus_t& bus,
                                   AlarmChecker& alarmChecker) :
    _bus(bus),
    _alarmChecker(alarmChecker),
    _hardShutdownMatch(
        bus,
...
void DbusAlarmMonitor::watchSensorAlarm(std::string sensorPath,
                                        AlarmType alarmType)
{
...
void DbusAlarmMonitor::stopWatchAlarm(std::string sensorPath,
                                      AlarmType alarmType)
{

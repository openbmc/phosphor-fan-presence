...
class Fan : public ConfigBase
{
  ...
  private:
    ...
    /**
     * @brief A copy of the fan's JSON entry, retained so that initSensors()
     *        can call setSensors() without needing to re-open fans.json.
     */
    json _jsonObj;
    ...
    /**
     * @brief Resolve sensor D-Bus paths from the stored JSON object.
     *

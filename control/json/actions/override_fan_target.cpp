...
{
    record("Locking minimum fan target " + std::to_string(_target) + " on fan Zone " + getUniqueName());
...
{
    record("Un-locking minimum target " + std::to_string(_target) + " on fan Zone " + getUniqueName());

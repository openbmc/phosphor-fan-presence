...
void PCIeCardCooling::execute(Zone& zone)
{
...
uint16_t PCIeCardCooling::getPCIeDeviceProperty(const std::string& objectPath,
...
std::optional<std::variant<int32_t, std::string>>
    PCIeCardCooling::getFloorIndexFromSlot(const std::string& slotPath)
{
...
const std::string& PCIeCardCooling::getCardFromSlot(const std::string& slotPath)
{

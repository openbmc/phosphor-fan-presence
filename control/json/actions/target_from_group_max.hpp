 ...
 * case and "pos_hysteresis" is for the decreasing case. The maximum value
 * property value in a group will be mapped to the "map" to get the output
 * "target". The updated "target" value of each group will be stored in a static
 * map with key "index". The maximum value from the static map will be used to
 * set to the Zone's target.
 *
 */
    ...
    public ActionRegister<TargetFromGroupMax>
{
  ...
  private:
    ...
    static uint16_t _groupIndexCounter;

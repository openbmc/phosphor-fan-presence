...
/**
 * @class FailureOverrideTarget - Action to override spindle speed when another
 * rotor fails
 *
 * When one spindle of a multi-rotor fan FRU fails, it is desirable to set the
 * other spindle to max RPM, overriding any previous setting. This action is
 * called when a failure is detected and forces the other spindle to its
 * override setting.
 */
class FailureOverrideTarget :
    public ActionBase,
    public ActionRegister<FailureOverrideTarget>
{
  public:
    /* Name of this action */
    static constexpr auto name = "failure_override_target";

    FailureOverrideTarget() = delete;
    FailureOverrideTarget(const FailureOverrideTarget&) = delete;
    FailureOverrideTarget(FailureOverrideTarget&&) = delete;
    FailureOverrideTarget& operator=(const FailureOverrideTarget&) = delete;
    FailureOverrideTarget& operator=(FailureOverrideTarget&&) = delete;
    ~FailureOverrideTarget() = default;
     ...
     */
    FailureOverrideTarget(const json& jsonObj,

...
void initCLI(CLI::App& app, uint64_t& target, std::vector<std::string> fanList)
{
    ...
    // set method
    strHelp = "Set target speed (all rotors) for one-or-more fans";
...
int main(int argc, char* argv[])
{
    ...
    {
        rc = -1;
        std::cerr << "fanctl failed: " << e.what() << std::endl;
    }

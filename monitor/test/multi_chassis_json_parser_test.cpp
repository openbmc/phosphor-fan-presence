...
TEST(MultiChassisJsonParserTest, FanAssignsTest)
{
    ...
    std::vector<FanAssignment> expected = {
        FanAssignment{
            .type = "systemFan",
            .inventoryBase =
                "/xyz/openbmc_project/inventory/system/0/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans =
                {FanAssignment{
                     .type = "systemFan",
                     .inventoryBase =
                         "/xyz/openbmc_project/inventory/system/1/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans =
                {FanAssignment{
                     .type = "systemFan",
                     .inventoryBase =
                         "/xyz/openbmc_project/inventory/system/2/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans =
                {FanAssignment{
                     .type = "systemFan",
                     .inventoryBase =
                         "/xyz/openbmc_project/inventory/system/3/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans =
                {FanAssignment{
                     .type = "systemFan",
                     .inventoryBase =
                         "/xyz/openbmc_project/inventory/system/4/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans =
                {FanAssignment{
                     .type = "systemFan",
                     .inventoryBase =
                         "/xyz/openbmc_project/inventory/system/5/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans =
                {FanAssignment{
                     .type = "systemFan",
                     .inventoryBase =
                         "/xyz/openbmc_project/inventory/system/6/motherboard/",
        ...
        ZoneDefinition{
            ...
            .fans = {
                FanAssignment{
                    .type = "systemFan",
                    .inventoryBase =
                        "/xyz/openbmc_project/inventory/system/7/motherboard/",

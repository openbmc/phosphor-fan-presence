...
class PowerOffCause
{
  public:
    ...
    PowerOffCause(const PowerOffCause&) = default;
    PowerOffCause& operator=(const PowerOffCause&) = default;
    PowerOffCause(PowerOffCause&&) = default;
    PowerOffCause& operator=(PowerOffCause&&) = default;
...
class MissingFanFRUCause : public PowerOffCause
{
  public:
    ...
    MissingFanFRUCause(const MissingFanFRUCause&) = default;
    MissingFanFRUCause& operator=(const MissingFanFRUCause&) = default;
    MissingFanFRUCause(MissingFanFRUCause&&) = default;
    MissingFanFRUCause& operator=(MissingFanFRUCause&&) = default;
...
class NonfuncFanRotorCause : public PowerOffCause
{
  public:
    ...
    NonfuncFanRotorCause(const NonfuncFanRotorCause&) = default;
    NonfuncFanRotorCause& operator=(const NonfuncFanRotorCause&) = default;
    NonfuncFanRotorCause(NonfuncFanRotorCause&&) = default;
    NonfuncFanRotorCause& operator=(NonfuncFanRotorCause&&) = default;

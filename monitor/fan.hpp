...
class Fan
{
    ...
    private:
        ...
        /**
         * @brief Returns true if the sensor input is below
         * some deviation of the target.
         *
         * @param[in] sensor - the sensor to check
         */
        bool tooSlow(const TachSensor& sensor);
         ...
         */
        functionalState _functional = functionalState::UNKNOWN;

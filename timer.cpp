    ...
    timeout(0)
{
    ...
    if (r < 0)
    {
        elog<xyz::openbmc_project::Common::Fan::TimerFailure>(
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure::RETURN_CODE(-r),
                phosphor::logging::xyz::openbmc_project::Common::Fan::
                    TimerFailure::MESSAGE("Timer::Timer failed call to sd_event_add_time"));
...
void Timer::setTimer(int action)
{
    ...
    if (r < 0)
    {
        elog<xyz::openbmc_project::Common::Fan::TimerFailure>(
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure::RETURN_CODE(-r),
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure
                    ::MESSAGE("Failed call to sd_event_source_set_enabled"));
    }
}
...
bool Timer::running()
{
    ...
    if (r < 0)
    {
        elog<xyz::openbmc_project::Common::Fan::TimerFailure>(
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure::RETURN_CODE(-r),
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure
                    ::MESSAGE("Failed call to sd_event_source_get_enabled"));
    }
...
void Timer::setTimeout()
{
    ...
    if (r < 0)
    {
        elog<xyz::openbmc_project::Common::Fan::TimerFailure>(
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure::RETURN_CODE(-r),
                phosphor::logging::xyz::openbmc_project::Common::Fan::TimerFailure
                    ::MESSAGE("Failed call to sd_event_source_set_time"));
    }
}

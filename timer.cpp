                          ...
                          uint64_t usec, void* userData)
{
    ...
    if (timer->getType() == TimerType::repeating)
    {
                  ...
                  TimerType timerType)
{
    ...
    {
        //Will only make the callback once, and then be disabled.
        setTimer(SD_EVENT_ONESHOT);
    }
    else //repeating
    {
        //Will make the callback every timeValue microseconds.
        setTimer(SD_EVENT_ON);
    }
}

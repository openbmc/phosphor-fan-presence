...
struct ControlFailure : public sdbusplus::exception_t
{
    static constexpr auto errName = "xyz.openbmc_project.Common.Fan.ControlFailure";
    static constexpr auto errDesc = "Fan Control Manager Failed";
    static constexpr auto L = level::ERR;
    using MESSAGE = _ControlFailure::MESSAGE;
    using metadata_types = std::tuple<MESSAGE>;
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Common::Fan::Error::ControlFailure>
{
    using type = xyz::openbmc_project::Common::Fan::ControlFailure;
};
